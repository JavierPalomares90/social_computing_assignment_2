...
\hspace*{21mm} 15. Print blocking pair found so no stable matching exists, then exit \\
\hspace*{14mm} 16. else: \\
\hspace*{21mm} 17. Continue through for loop to next marriage assignment (m,w) \\ 
